...
__all__ = ['FaceDetector','Face']


class FaceDetector:
    def __init__(self, device='cuda:0'):
        model_path='./models/buffalo_m/face_detection_retina.pkl'
        meta_path='./models/buffalo_m/model_meta.json'
        try:
        ...
        self.meta_conf = json.load(open(meta_path, 'r'))
        self.cfg = {}
    ...
    def _postprocess(self, loc, conf, scale, input_height, input_width):
        ...
        boxes = self.decode(loc.data.squeeze(
